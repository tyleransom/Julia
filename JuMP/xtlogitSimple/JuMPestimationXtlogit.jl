...
include("datagen.jl")
include("JuMPxtlogitMLE.jl")
include("lgwt.jl")

# evaluate the functions referenced above in the -include- statements. -@time- is equivalent to tic/toc in Matlab
@time X,Y,bxAns,sigAns,n,N,T,J,K1,baseAlt = datagen() # specify function outputs on the left hand side of the equals sign
...
# optimize
@time bxOpt,sigOpt,hOpt,seOpt = JuMPxtlogitMLE()
